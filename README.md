...
|MAPPING_FILEPATH|/input/Limits_other.xlsx|Filepath for "DD20 name to SCADA AC-line name mapping" excel-file.|
...
|MOCK_MAPPING_FILEPATH|tests/valid-testdata/Limits_other.xlsx|Filepath for "DD20 name to SCADA AC-line name mapping" excel-file.|
