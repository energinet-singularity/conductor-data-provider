...
def test_extract_conducter_data_from_dd20():
    ...
    expected_dict = {'ACLINE_EMSNAME_EXPECTED': ['E_EEE-FFF-1', 'E_EEE-FFF-2', 'E_GGG-HHH', 'E_AAA-BBB', 'D_CCC-DDD', 'C_III-ÆØÅ'],
                     ...
                     'RESTRICTIVE_COMPONENT_LIMIT_CONTINUOUS': [455, 455, 1111, 1222, 1333, 1444],
    ...
    dd20_dataframe = code.parse_excel_sheets_to_dataframe_dict(file_path=dd20_filepath,
                                                               sheets=['Stationsdata'],
                                                               header_index=[1])


    resulting_dd20_dataframe = code.extract_conducter_data_from_dd20(dataframe_station=dd20_dataframe['Stationsdata'],dataframe_line=None)
...
def test_combine_conduct_info_to_pandas():
    ...
    expected_dict = {'LINESEGMENT_MRID': ['d51269gh-25e0-4a11-b32e-bd0fba7af745',
                     ...
                     'DLR_ENABLED': [True, True, True, False, True, True]
